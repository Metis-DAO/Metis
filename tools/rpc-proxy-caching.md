...
projects:
  - id: main
    upstreams:
      # You don't need to define architecture (e.g. evm) or chain id (e.g. 1088)
      # as they will be detected automatically by eRPC.
      - endpoint: https://metis-mainnet.blastapi.io/xxxx
...
```bash
curl --location 'http://localhost:4000/main/evm/1088' \
